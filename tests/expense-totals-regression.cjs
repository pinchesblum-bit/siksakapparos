...
const nodes={expenseUnpaidTotal:{},expensePaidTotal:{}};
...
env.renderExpenseList(env.getAccountingExpenses(),'2026-09',true);assert.equal(nodes.expenseUnpaidTotal.textContent,'$1000.30');assert.equal(nodes.expensePaidTotal.textContent,'$40.23');
...
env.renderExpenseList([],'2026-10',false);assert.equal(nodes.expenseUnpaidTotal.textContent,'$0.00');assert.equal(nodes.expensePaidTotal.textContent,'$0.00');
